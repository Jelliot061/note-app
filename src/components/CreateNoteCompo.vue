<template>
    <div class="app-container">
      <h2 style="text-align: center;">Note Application</h2>
      <h3>User: {{ user }}</h3>
      <form class="note-form" @submit.prevent="addNote">
        <input type="text" v-model="newNote.title" placeholder="Title" required />
        <textarea v-model="newNote.description" placeholder="Description" rows="5" cols="15"></textarea>
  ...
  text-overflow: auto; /* Display ellipsis (...) when text overflows */
  }
  </style>
